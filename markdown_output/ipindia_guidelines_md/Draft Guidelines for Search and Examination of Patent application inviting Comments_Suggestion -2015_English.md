...
GUIDELINES FOR SEARCH AND EXAMINATION OF PATENT APPLICATIONS 
...
1.5 Disclaimer 
2. Patent application processing flow- a brief  
2.1 Application Filing 
2.2 Screening and classification  
2.3 publication 
2.4 Request for examination 
 
3. Overview of Patent Examination 
3.1 Mandate of law 
3.2 Formal Examination 
3.2.1 
Timelines of filing documents and RQs, Forms and fee, right to file, priority rights 
etc. 
...
5. Search for novelty and inventive step 
...
6. Examination standards and detailed official requirements 
7. Amendments (types, before/ after grant, allowability, clerical error etc.) 
8. Pre-grant disposal procedure 
9. Examination Report writing methodology 
10. Examination procedure at amended stage 
11. Abandoning, refusal and grant procedure  
12. Disposal of post grant opposition 
13. Disposal of post grant amendments 
14. Review of Controllers’ decision (procedure) 
 
Annexure: 
1. Annexure-I: Table Showing the time provided under the Patents Act and Rules 
2. Annexure-II: Official Notification with regard to Atomic Energy 
...
foods and products of chemical reactions but no product patents were allowed for inventions 
...
applications has been described in brief. The processing so explained comprises of steps of 
...
Page 14 of 115 
 ...
 It is to be noted that there is no provision for  filing provisional specification  or making a 
...
The technical advance, synergistic effect and efficacy of the claimed invention must be 
...
Terms already having an established meaning should not be used differently, if this is 
...
(d) Each claim is evaluated on its own merit and, therefore, if one of the claims is 
...
“when required” or “any” are used, then it forces the reader to make a subjective 
...
after will be the features of the invention. It is equally applicable in the case of a 
...
a) I claim that this device is better and cheaper and more effectual than anything 
known. 
...
Unity of invention is present only when there is a “technical relationship” among the 
...
(d) Unity between product and process claims requires that the process inherently 
...
i) 
In a case where a prior art is cited as an anticipation in the Examination Report, which 
...
In order to demonstrate lack of novelty, the anticipatory disclosure must be entirely 
...
alternatives,  or  if  a  single example falling within this range, is already known.  Thus, a 
...
by threaded fasteners & also disclosing an antiroll bar consisting of tubes and 
...
2. A document is not considered as a proper anticipation unless it gives the public the 
...
7. In the case of Ram Narain Kher v. Ambassador Industries, (AIR 1976 Del 87.), it was 
...
(1) 
The examiner to whom an application for a patent is referred under section 12 shall 
...
patented invention, would he have said, "this gives me what I want?" (Encyclopaedia 
...
already known characteristics of composition with known ingredients cannot be termed 
...
5. In  Franz Zaver Huemer v. New Yesh Engineers, (1996 PTC (16) 164 Del.) the court 
...
3.4.3 
Industrial Applicability: Concept  
...
Page 41 of 115 
 ...
 “A method of showing time on the basis of metric system” wherein dial of time piece 
...
(iv) 
 An invention, the primary or proposed use of which would disturb the public  order   
...
animals which are likely to cause them suffering without  any substantial medical or other 
...
2. Invention: An extract of Calotrophis gigantea containing cardiac glycosides having 
...
paracetamol as analgesic can not be patented. Similarly, ethyl alcohol is used as solvent but 
...
matter in the idea of the working inter relations brought about by the collocation of the 
integers. 
...
known device does not amount to an invention. As sufficient ground exists for revocation of 
...
attraction will be enhanced, how the hair of the lady will be protected. But if the verbal 
...
(g) Any method of treatment of animal to render them free of disease or to increase their 
...
matter involved is of a new process of preparation of vaccine under specific scientific 
...
these categories, then, the subject matter is examined with a view to decide whether it is a 
...
such excluded from patentability, because they are considered as outcome of  
mere 
mental process. 
...
Any manner, means or method of expressing information whether visual, audible or tangible 
...
traditional knowledge in India or is an aggregation or duplication of known properties of 
...
4.1 
Importance, necessity and details 
...
(c) Main Group Title – The main group title precisely defines a field of subject matter within 
...
particular use or property. Classifying of such subject matter according to only one aspect 
...
IPC Stats search using the expression “formoterol and beclometasone and asthma” results in 
...
5.1 
Concepts including search standards 
...
AND 
Finds records containing both (All) words 
NOT 
...
nD 
The terms adjacent, regardless of the order, separated by a maximum of n words (n 
value between 1 and 99) 
=nD 
The terms adjacent, regardless of the order, separated by exactly n words (n value 
between 1 and 99) 
...
W 
The terms adjacent in the order specified; treatment applied by default for two 
terms entered without operator 
nW 
The adjacent terms in the order specified and separated by a maximum of n words 
(n value between 1 and 99) 
_ 
The underscore allows for simultaneous searching of terms that may be written as 
...
5.2 
Guidance (search strategy, databases, methodology, recording, reporting etc) 
Novelty search 
...
must stand on its own, or the documents so cited are linked in such a manner so that they form 
...
solution has been completely administered into the human body, the protrusion is inserted in 
...
(PROTRU+ OR EXTEN+) P (LOCK+) P (GROOVE OR CHANNEL OR FURROW))/ 
CLAIMS/DESCRIPTION/OBJECTIVE/TEXT/ABSTRACT 
AND 
((PISTON) 
P 
(BREAK 
...
(PROTRU+ 
OR 
EXTEN+))/CLAIMS/DESCRIPTION/OBJECTIVE/TEXT/ABSTRACT 
AND 
...
7 ( ((DISABLE+) P (SYRINGE OR HYPODERM+) P (NEEDLE OR BARREL) P (PISTON OR PLUNGER) P 
(PROTRU+ 
OR 
EXTEN+))/ 
CLAIMS/DESCRIPTION/OBJECTIVE/TEXT/ABSTRACT 
...
DEPOSITION)/CLAIMS/DESCRIPTION/OBJECTIVE/TEXT/ABSTRACT 
AND 
...
PUBLICATION_DATE <= 2006-10-19 =5results 
Search Example 4: 
Claim :  
...
2. 
1 AND (ELECTRON DONOR)= 10 results 
3. 
2  AND (ELECTRON ACCEPTOR) = 6 results 
...
1. 
If the specification specifically discloses the source and geographical origin as from 
...
2. 
If the applicant himself files the application without employing any attorney, 
...
6.4 Comprehensive examination report 
...
The provisions of the section 57 shall be without prejudice to the right of an applicant to 
...
The amendments sought through F13 may also include an amendment to the priority date. 
...
Section 58 allows us to use our discretion to amend if we decide that the patent is invalid. 
...
The applicant shall, if he so desires, give reply to that representation along with his statement 
...
Page 80 of 115 
 ...
 The FER is sent to the applicant, even when the request for examination has been filed by a 
...
to D1 alone both for novelty and for inventive step. But the order does not indicate why the 
...
o The fact that the patent has been granted is published in the official journal of the 
Patent Office.  
...
 No further evidence shall be delivered by either party, except with the leave or direction of 
Controller. 
...
Hearing in post grant opposition matters 
...
by the Controller. 
14. 
Disposal of the examination report 
14 
24B(2)(
...
by the Controller 
16. 
Post dating of the application at the 
...
copy) to be filed.  
18. 
Potential infringement, reference to 
...
date of FER.   
21. 
Power of Controller to refuse or 
...
be issued.  
25. 
Post-grant opposition along with 
...
Controller. 
27. 
Permission to apply for patent 
outside India 
39 
71 
(1&2) 
...
application.  
31. 
Application for restoration of lapsed 
patent 
60 
84(1) 
15 
...
effect.  
32. 
Procedure for the disposal of the 
...
S.O. 61(E).- 
In pursuance of clauses (f) and (g) of sub-section (1) of Section 2 and Section 
...
a. 
    Uranium (containing the mixture of isotopes in nature) exceeding 100    
kilograms. 
b. 
     Depleted uranium (uranium depleted in the isotope 235 below that occurring in 
...
Note: 
Any quantity of special fissionable material is prescribed substance. 
...
OA302 
Nuclear grade graphite / carbon, having a purity level better than 5 parts per 
...
OA303 
Zirconium with hafnium content of less than 1 part to 500 parts of zirconium 
...
OA304 
Beryllium, its compound, alloys and its minerals/concentrates including Beryl 
but excluding: 
...
OA305 
Lithium enriched in the Lithium-6 (6Li) isotope to greater than its natural isotope 
...
OA306 
Niobium and Tantalum, their metals, alloys and minerals including columbite 
and tantalite. 
...
OA308 
Tritium, tritium compounds or mixtures containing tritium in which the ratio 
...
Americium-242m 
Californium-248 
           Calfornium-250 Californium-252 
Californium-253 
          Calfornium-254 
            Carium-240 
Curium-241           Curium-242 
            Curium-243 
Curium-244          Einsteinium-252 
            Einsteinium-253 
Einsteinium-254 
         Einsteinium-255 
            Fermium-257 
Gadolinium-148 
         Mendelevioum-258        Neptunium-235 
Plutonium-236 
        Plutonium-237 
            Plutonium-238 
Plutonium-241 
...
Polonium-210 
Polonium-208     Radium-223  
Thorium-228 
Thorium-227     Uranium-230  
Uranium-232 
...
*Note: 
These items (OA314 and OA315) shall remain prescribed substances 
...
f. 
        Zirconium tubes and assembles of tubes in which hafnium to zirconium ratio 
is 1:500 or less 
g. 
...
i. 
Heat exchangers (steam generators) for use in the primary   coolant circuit of    
a nuclear reactor 
j. 
...
OB002 
Plants for processing, production, concentration, conversion or recovery of 
...
water, tritium, lithium); associated equipment, components and system, specially 
...
3. 
Ammonia-Hydrogen Exchange Towers greater than or equal to 35m in height 
...
6. 
Infrared Absorption Analyzers capable of ‘on-line’ hydrogen/deuterium ratio 
analysis 
7. 
Catalytic Burners for conversion of enriched deuterium gas into heavy water 
8. 
Complete heavy water upgrade systems or columns therefore 
9. 
...
d. 
Tritium facilities or plants, and equipments therefore 
...
OB005  
All systems, associated equipment, components for separation or enrichment of 
...
OB007 
Plants or systems for production, handling, storage and transportation of 
Radioisotopes in quantities exceeding 100 Curies (3.7 X 10 12 Becquerel). 
 
OB008 
Neutron generators including neutron chain reacting assemblies and fusion 
...
Note: 
The numbering system followed in this Schedule is in harmony with the numbering 
